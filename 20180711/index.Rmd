...
Think of a question you'd like to ask of your data via a (linked) interactive graphic (bonus: draw it)!
...
Use `plotly_json()` to study how the R code (on the [last slide](#33)) maps to JSON.
...
Remember [this](#17) "your turn"? Let's try to implement it!
