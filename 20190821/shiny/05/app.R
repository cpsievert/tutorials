...
ui <- fluidPage(
  p(
    "Click on different points and notice how `select_data()` (printed in the window below the scatterplot)",
    " contains both the drug clicked, as well as the color used to represent it."
  ),
  tags$b("Your Turn:"),
  p("Modify the app to display a bar chart of reaction `outcomes` for each selected drug"),
  plotlyOutput("p"),
