...
ui <- fluidPage(
  ...
  p(tags$b("Your turn:")),
  p("1. Modify the click output to display all the reactions for the clicked drug."),
  p("2. Modify the click output again, this time to display bar chart of reaction counts for the clicked drug."),
  plotlyOutput("p"),
